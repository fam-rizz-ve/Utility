...
public class LiminalyKeyQuandoSiFaClicConIlPulsanteDestroDelMouseProcedure {
	public static void execute(Entity entity) {
		...
		{
			UtilityModVariables.PlayerVariables _vars = entity.getData(UtilityModVariables.PLAYER_VARIABLES);
			_vars.chiave_appena_usata = "liminal key";
			_vars.markSyncDirty();
		}
		if (entity instanceof ServerPlayer _player && !_player.level().isClientSide()) {
			ResourceKey<Level> destinationType = ResourceKey.create(Registries.DIMENSION, ResourceLocation.parse("utility:liminal_dimension"));
