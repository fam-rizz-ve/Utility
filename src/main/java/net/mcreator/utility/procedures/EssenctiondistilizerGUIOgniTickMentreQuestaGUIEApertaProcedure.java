...
public class EssenctiondistilizerGUIOgniTickMentreQuestaGUIEApertaProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		if (entity == null)
			return;
		if (getAmountInGUISlot(entity, 7) <= 1
				&& (entity instanceof Player _plrSlotItem && _plrSlotItem.containerMenu instanceof UtilityModMenus.MenuAccessor _menu1 ? _menu1.getSlots().get(0).getItem() : ItemStack.EMPTY).getItem() == Items.ENDER_PEARL
			...
			if (world instanceof ILevelExtension _ext && _ext.getCapability(Capabilities.ItemHandler.BLOCK, BlockPos.containing(x, y, z), null) instanceof IItemHandlerModifiable _itemHandlerModifiable) {
				ItemStack _setstack = new ItemStack(UtilityModItems.ENDESSECE.get()).copy();
				_setstack.setCount(getAmountInGUISlot(entity, 7) + 1);
				_itemHandlerModifiable.setStackInSlot(7, _setstack);
			}
		}
		if (getAmountInGUISlot(entity, 7) <= 1
				&& (entity instanceof Player _plrSlotItem && _plrSlotItem.containerMenu instanceof UtilityModMenus.MenuAccessor _menu30 ? _menu30.getSlots().get(0).getItem() : ItemStack.EMPTY).getItem() == Blocks.ANCIENT_DEBRIS.asItem()
			...
			if (entity instanceof Player _player && _player.containerMenu instanceof UtilityModMenus.MenuAccessor _menu) {
				...
				_menu.getSlots().get(5).remove(1);
				_menu.getSlots().get(6).remove(1);
				ItemStack _setstack57 = new ItemStack(UtilityModItems.NEHTERESSENCE.get()).copy();
				_setstack57.setCount(getAmountInGUISlot(entity, 7) + 1);
				_menu.getSlots().get(7).set(_setstack57);
				_player.containerMenu.broadcastChanges();
			}
		}
		if (getAmountInGUISlot(entity, 7) <= 1
				&& (entity instanceof Player _plrSlotItem && _plrSlotItem.containerMenu instanceof UtilityModMenus.MenuAccessor _menu59 ? _menu59.getSlots().get(0).getItem() : ItemStack.EMPTY).getItem() == Items.PRISMARINE_SHARD
			...
			if (entity instanceof Player _player && _player.containerMenu instanceof UtilityModMenus.MenuAccessor _menu) {
				...
				_menu.getSlots().get(5).remove(1);
				_menu.getSlots().get(6).remove(1);
				ItemStack _setstack86 = new ItemStack(UtilityModItems.OVERWORLDESSENCE.get()).copy();
				_setstack86.setCount(getAmountInGUISlot(entity, 7) + 1);
				_menu.getSlots().get(7).set(_setstack86);
				_player.containerMenu.broadcastChanges();
			}
		}
	}
	...
	private static int getAmountInGUISlot(Entity entity, int sltid) {
		if (entity instanceof Player player && player.containerMenu instanceof UtilityModMenus.MenuAccessor menuAccessor) {
