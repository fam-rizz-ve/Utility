...
public class OverwordkeyRightclickedOnBlockProcedure {
	public static void execute(Entity entity) {
		...
		{
			Entity _ent = entity;
			_ent.teleportTo(entity.getData(UtilityModVariables.PLAYER_VARIABLES).ultima_x_overword, entity.getData(UtilityModVariables.PLAYER_VARIABLES).ultima_y_overword, entity.getData(UtilityModVariables.PLAYER_VARIABLES).ultima_z_overword);
			if (_ent instanceof ServerPlayer _serverPlayer)
				_serverPlayer.connection.teleport(entity.getData(UtilityModVariables.PLAYER_VARIABLES).ultima_x_overword, entity.getData(UtilityModVariables.PLAYER_VARIABLES).ultima_y_overword,
						entity.getData(UtilityModVariables.PLAYER_VARIABLES).ultima_z_overword, _ent.getYRot(), _ent.getXRot());
		}
		{
			UtilityModVariables.PlayerVariables _vars = entity.getData(UtilityModVariables.PLAYER_VARIABLES);
			_vars.chiave_appena_usata = "overword key";
			_vars.markSyncDirty();
		}
