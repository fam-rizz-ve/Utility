...
public class OverwordkeyRightclickedOnBlockProcedure {
	public static void execute(Entity entity) {
		...
		{
			Entity _ent = entity;
			double _tx = entity.getData(UtilityModVariables.PLAYER_VARIABLES).ultima_x_overword;
			double _ty = entity.getData(UtilityModVariables.PLAYER_VARIABLES).ultima_y_overword;
			double _tz = entity.getData(UtilityModVariables.PLAYER_VARIABLES).ultima_z_overword;
