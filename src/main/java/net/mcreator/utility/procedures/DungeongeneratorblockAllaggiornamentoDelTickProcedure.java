...
public class DungeongeneratorblockAllaggiornamentoDelTickProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		...
		for (int index0 = 0; index0 < 10; index0++) {
			numero_casuale_quale_tipo_di_stanza = Mth.nextInt(RandomSource.create(), 13, 13);
			if (numero_casuale_quale_tipo_di_stanza == 1) {
			...
			} else if (numero_casuale_quale_tipo_di_stanza == 2) {
			...
			} else if (numero_casuale_quale_tipo_di_stanza == 3) {
				if (ControllasevuotoProcedure.execute(world, x, y, z, 5, 9, 9, 0, 0, "normal", "centrata")) {
					if ((new Object() {
						public Direction getDirection(BlockPos pos) {
							BlockState _bs = world.getBlockState(pos);
			...
			} else if (numero_casuale_quale_tipo_di_stanza == 4) {
			...
			} else if (numero_casuale_quale_tipo_di_stanza == 5) {
			...
			} else if (numero_casuale_quale_tipo_di_stanza == 6) {
				if (ControllasevuotoProcedure.execute(world, x, y, z, 12, 5, 9, 3, 0, "non centrata", "centrata")) {
					if ((new Object() {
						public Direction getDirection(BlockPos pos) {
							BlockState _bs = world.getBlockState(pos);
							Property<?> property = _bs.getBlock().getStateDefinition().getProperty("facing");
			...
			} else if (numero_casuale_quale_tipo_di_stanza == 7) {
				if (ControllasevuotoProcedure.execute(world, x, y, z, 12, 5, 9, 8, 0, "non centrata", "centrata")) {
					if ((new Object() {
						public Direction getDirection(BlockPos pos) {
							BlockState _bs = world.getBlockState(pos);
							Property<?> property = _bs.getBlock().getStateDefinition().getProperty("facing");
			...
			} else if (numero_casuale_quale_tipo_di_stanza == 8) {
			...
			} else if (numero_casuale_quale_tipo_di_stanza == 9) {
				if (ControllasevuotoProcedure.execute(world, x, y, z, 7, 9, 9, 0, 0, "normal", "centrata")) {
					if ((new Object() {
						...
						if (world instanceof ServerLevel _serverworld) {
							StructureTemplate template = _serverworld.getStructureManager().getOrCreate(ResourceLocation.fromNamespaceAndPath("utility", "liminal_core_room"));
							if (template != null) {
			...
			} else if (numero_casuale_quale_tipo_di_stanza == 10) {
			...
			} else if (numero_casuale_quale_tipo_di_stanza == 11) {
				if (ControllasevuotoProcedure.execute(world, x, y, z, 9, 15, 15, 0, 0, "normal", "centrata")) {
					if ((new Object() {
						...
						if (world instanceof ServerLevel _serverworld) {
							StructureTemplate template = _serverworld.getStructureManager().getOrCreate(ResourceLocation.fromNamespaceAndPath("utility", "liminal_hourglass_room"));
							if (template != null) {
				...
				if (ControllasevuotoProcedure.execute(world, x, y, z, 7, 15, 14, 0, 0, "normal", "centrata")) {
					if ((new Object() {
						...
						if (world instanceof ServerLevel _serverworld) {
							StructureTemplate template = _serverworld.getStructureManager().getOrCreate(ResourceLocation.fromNamespaceAndPath("utility", "liminal_strange_lab"));
							if (template != null) {
