...
public class OmniWandPulsanteSinistraCambioPlayer1Procedure {
	public static void execute(LevelAccessor world, Entity entity) {
		if (entity == null)
			return;
		if (entity.getData(UtilityModVariables.PLAYER_VARIABLES).indice_correnteOmniWand1 > 0) {
			{
			...
			{
				UtilityModVariables.PlayerVariables _vars = entity.getData(UtilityModVariables.PLAYER_VARIABLES);
				_vars.indice_correnteOmniWand1 = UtilityModVariables.MapVariables.get(world).numeroDiGIocatori;
				_vars.markSyncDirty();
			}
		}
		{
