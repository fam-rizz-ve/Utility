	...
	public static void execute(Entity entity) {
			...
			return;
		{
			...
			if (!projectileLevel.isClientSide()) {
				Projectile _entityToSpawn = initArrowProjectile(new TacticalknifeprojectileEntity(UtilityModEntities.TACTICALKNIFEPROJECTILE.get(), 0, 0, 0, projectileLevel, createArrowWeaponItemStack(projectileLevel, 1, (byte) 0)), null, 5, true,
