...
public class HowPlayerEnterInADimensionProcedure {
	...
	private static void execute(@Nullable Event event, LevelAccessor world, double x, double y, double z, Entity entity) {
		if (entity == null)
			return;
		if ((entity.getData(UtilityModVariables.PLAYER_VARIABLES).switch_dimension).equals("true")) {
			{
				UtilityModVariables.PlayerVariables _vars = entity.getData(UtilityModVariables.PLAYER_VARIABLES);
				_vars.switch_dimension = "false";
				_vars.markSyncDirty();
			}
			if (world instanceof Level _level) {
				if (!_level.isClientSide()) {
					_level.playSound(null, BlockPos.containing(x, y, z), BuiltInRegistries.SOUND_EVENT.get(ResourceLocation.parse("utility:magical_key")), SoundSource.NEUTRAL, 3, 1);
				} else {
					_level.playLocalSound(x, y, z, BuiltInRegistries.SOUND_EVENT.get(ResourceLocation.parse("utility:magical_key")), SoundSource.NEUTRAL, 3, 1, false);
				}
			}
			if (!world.getBlockState(BlockPos.containing(x, y - 1, z)).canOcclude()) {
				if ((entity.getData(UtilityModVariables.PLAYER_VARIABLES).chiave_appena_usata).equals("flate key") || (entity.getData(UtilityModVariables.PLAYER_VARIABLES).chiave_appena_usata).equals("overword key")) {
				...
				} else if ((entity.getData(UtilityModVariables.PLAYER_VARIABLES).chiave_appena_usata).equals("nether key")) {
					if (world instanceof ServerLevel _level)
						_level.getServer().getCommands().performPrefixedCommand(new CommandSourceStack(CommandSource.NULL, new Vec3(x, (y - 1), z), Vec2.ZERO, _level, 4, "", Component.literal(""), _level.getServer(), null).withSuppressedOutput(),
								"fill ~-1 ~ ~-1 ~1 ~ ~1 minecraft:netherrack");
				} else if ((entity.getData(UtilityModVariables.PLAYER_VARIABLES).chiave_appena_usata).equals("end key")) {
					if (world instanceof ServerLevel _level)
						_level.getServer().getCommands().performPrefixedCommand(new CommandSourceStack(CommandSource.NULL, new Vec3(x, (y - 1), z), Vec2.ZERO, _level, 4, "", Component.literal(""), _level.getServer(), null).withSuppressedOutput(),
			...
			if ((entity.getData(UtilityModVariables.PLAYER_VARIABLES).chiave_appena_usata).equals("limbo key")) {
				...
				{
					UtilityModVariables.PlayerVariables _vars = entity.getData(UtilityModVariables.PLAYER_VARIABLES);
					_vars.ultima_gamemode = DeterminamodalitaProcedure.execute(entity);
					_vars.markSyncDirty();
				}
			...
			if ((entity.getData(UtilityModVariables.PLAYER_VARIABLES).chiave_appena_usata).equals("liminal key")) {
			...
			if ((entity.getData(UtilityModVariables.PLAYER_VARIABLES).chiave_appena_usata).equals("flate key")) {
				if (entity instanceof Player _player) {
					ItemStack _stktoremove = new ItemStack(UtilityModItems.FLATKEY.get());
					_player.getInventory().clearOrCountMatchingItems(p -> _stktoremove.getItem() == p.getItem(), 1, _player.inventoryMenu.getCraftSlots());
				}
			} else if ((entity.getData(UtilityModVariables.PLAYER_VARIABLES).chiave_appena_usata).equals("overword key")) {
				if (entity instanceof Player _player) {
			...
			} else if ((entity.getData(UtilityModVariables.PLAYER_VARIABLES).chiave_appena_usata).equals("limbo key")) {
				if (entity instanceof Player _player) {
					ItemStack _stktoremove = new ItemStack(UtilityModItems.LIMBOKEY.get());
					_player.getInventory().clearOrCountMatchingItems(p -> _stktoremove.getItem() == p.getItem(), 1, _player.inventoryMenu.getCraftSlots());
				}
			} else if ((entity.getData(UtilityModVariables.PLAYER_VARIABLES).chiave_appena_usata).equals("liminal key")) {
				if (entity instanceof Player _player) {
			...
			} else if ((entity.getData(UtilityModVariables.PLAYER_VARIABLES).last_key).equals("limbo key")) {
				if (entity instanceof Player _player) {
			...
			} else if ((entity.getData(UtilityModVariables.PLAYER_VARIABLES).last_key).equals("liminal key")) {
				if (entity instanceof Player _player) {
			...
			{
				UtilityModVariables.PlayerVariables _vars = entity.getData(UtilityModVariables.PLAYER_VARIABLES);
				_vars.last_key = entity.getData(UtilityModVariables.PLAYER_VARIABLES).chiave_appena_usata;
				_vars.markSyncDirty();
			}
		}
	}
