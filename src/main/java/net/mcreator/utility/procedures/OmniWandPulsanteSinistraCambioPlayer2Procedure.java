...
public class OmniWandPulsanteSinistraCambioPlayer2Procedure {
	public static void execute(LevelAccessor world, Entity entity) {
		if (entity == null)
			return;
		if (entity.getData(UtilityModVariables.PLAYER_VARIABLES).indiceCorrenteOmniWand2 > 0) {
			{
			...
			{
				UtilityModVariables.PlayerVariables _vars = entity.getData(UtilityModVariables.PLAYER_VARIABLES);
				_vars.indiceCorrenteOmniWand2 = UtilityModVariables.MapVariables.get(world).numeroDiGIocatori;
				_vars.markSyncDirty();
			}
		}
		{
