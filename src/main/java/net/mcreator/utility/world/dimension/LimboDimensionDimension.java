...
public class LimboDimensionDimension {
	@EventBusSubscriber(Dist.CLIENT)
	public static class LimboDimensionSpecialEffectsHandler {
		@SubscribeEvent
		public static void registerDimensionSpecialEffects(RegisterDimensionSpecialEffectsEvent event) {
			...
			event.register(ResourceLocation.parse("utility:limbo_dimension"), customEffect);
		}
	}
}