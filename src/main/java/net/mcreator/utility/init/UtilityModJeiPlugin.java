...
public class UtilityModJeiPlugin implements IModPlugin {
	...
	public ResourceLocation getPluginUid() {
		return ResourceLocation.parse("utility:jei_plugin");
	}
	...
	public void registerRecipes(IRecipeRegistration registration) {
		...
		List<EssenctionDistillizerJEIRecipeTypeRecipe> EssenctionDistillizerJEIRecipeTypeRecipes = recipeManager.getAllRecipesFor(EssenctionDistillizerJEIRecipeTypeRecipe.Type.INSTANCE).stream().map(RecipeHolder::value).collect(Collectors.toList());
