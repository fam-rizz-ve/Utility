...
public class UtilityModJeiInformation implements IModPlugin {
	...
	public ResourceLocation getPluginUid() {
		return ResourceLocation.parse("utility:information");
	}
	...
	public void registerRecipes(IRecipeRegistration registration) {
		...
		registration.addIngredientInfo(List.of(new ItemStack(UtilityModItems.LIMBO_KEY_PART_1.get())), VanillaTypes.ITEM_STACK, Component.translatable("jei.utility.frammento_liminal_key_jei_info"));
	}
}