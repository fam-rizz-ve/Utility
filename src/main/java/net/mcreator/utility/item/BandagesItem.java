...
import net.mcreator.utility.procedures.BandagesQuandoUnentitaUsaLoggettoProcedure;

import java.util.List;

public class BandagesItem extends Item {
	public BandagesItem() {
		super(new Item.Properties().stacksTo(32).food((new FoodProperties.Builder()).nutrition(0).saturationModifier(0f).alwaysEdible().build()));
	}
