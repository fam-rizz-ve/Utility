...
import net.mcreator.utility.init.*;
...
public class UtilityMod {
	public static final Logger LOGGER = LogManager.getLogger(UtilityMod.class);
	public static final String MODID = "utility";

	public UtilityMod(IEventBus modEventBus) {
		...
		UtilityModItems.REGISTRY.register(modEventBus);
		UtilityModEntities.REGISTRY.register(modEventBus);
		UtilityModTabs.REGISTRY.register(modEventBus);
		UtilityModVariables.ATTACHMENT_TYPES.register(modEventBus);
		UtilityModMobEffects.REGISTRY.register(modEventBus);
		UtilityModMenus.REGISTRY.register(modEventBus);
