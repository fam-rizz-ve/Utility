...
public class WateressenceEnchantment extends Enchantment {
	private static final EnchantmentCategory ENCHANTMENT_CATEGORY = EnchantmentCategory.create("utility_wateressence", item -> Ingredient.of(ItemTags.create(ResourceLocation.tryParse("forge:sword"))).test(new ItemStack(item)));
